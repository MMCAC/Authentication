...
import { auth } from '../../config/firebase'
  ...
  const [showSuccessMessage, shouldShowSucessMessage] = useState(false)
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.messagesArea}>
          {showSuccessMessage && <h3 className={styles.sucessCard}>Usuário cadastrado! Clique <Link to='/'>aqui</Link> para realizar o login</h3>}

          {showErrorMessage && <h3 className={styles.errorCard}>{message}</h3>}
        </div>
